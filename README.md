...
* [MINX][92] - MINX Is Not XNA; a framework resembling XNA. Implemented in
  C++. [3-clause BSD][29].
  * [NixieFX](#NEW_NUMBER) - An open-source particle effects runtime for HTML5 games, with renderer adapters for Three.js and PixiJS. Implemented in TypeScript. [MIT](#139).
